...
(function(){
  ...
  function setUI(playing){
    if(playing){label.textContent='SOUND ON';btn.classList.add('playing')}
    else{label.textContent='SOUND OFF';btn.classList.remove('playing')}
  }
